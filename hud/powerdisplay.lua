...
local tick = 0
-- Helper function to log messages to a file (ensure the /home/NIDAS/logs/ directory exists)
local function logToFile(message)
    local logFilePath = "/home/NIDAS/logs/energyDisplay.log"
...
function powerDisplay.widget(glasses, data)
    if data ~= nil then
        ...
        if data.state ~= states.MISSING then
            ...
            logToFile("After wireless mode check: wirelessMode = " .. tostring(energyData.wirelessMode) .. ", currentEU = " .. currentEU .. ", maxEU = " .. maxEU)
            ...
            logToFile("Tick updated: tick = " .. tick .. ", percentage = " .. percentage)
